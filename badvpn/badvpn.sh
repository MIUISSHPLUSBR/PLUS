...
fun_udp1 () {
    ...
    menu
	    ...
	    inst_udp () {
            ...
            wget https://raw.githubusercontent.com/MIUISSHLLUSBR/PLUS/main/badvpn/badvpn-udpgw -o /dev/null
			wget https://raw.githubusercontent.com/MIUISSHLLUSBR/PLUS/main/badvpn/antcrashvpn.sh -o /dev/null
